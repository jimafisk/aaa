...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*intro*/ 2 && raw_value !== (raw_value = /*paragraph*/ ctx[11] + "")) p.innerHTML = raw_value;;
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			const grid_changes = {};
			if (dirty & /*postRangeLow*/ 32) grid_changes.postRangeLow = /*postRangeLow*/ ctx[5];
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*postRangeHigh*/ 16) {
			$: $$invalidate(5, postRangeLow = postRangeHigh - postsPerPage);
		}
	};
